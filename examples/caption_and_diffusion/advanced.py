...
class TextToImagePlugin(IFieldsPlugin):
    ...
    def settings(self) -> IPluginSettings:
        return IPluginSettings(
            ...
            src="https://user-images.githubusercontent.com/15677328/234642061-98636956-4e3b-44ef-a670-a478bc9eb4ca.svg",
...
class ImageCaptioningPlugin(IFieldsPlugin):
    ...
    def settings(self) -> IPluginSettings:
        return IPluginSettings(
            ...
            src="https://user-images.githubusercontent.com/15677328/234642056-79e20fc9-0005-4e0e-8365-3285af8803ae.svg",
