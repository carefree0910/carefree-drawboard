...
export enum UI_Words {
  ...
  "list-field-settings-header" = "list-field-settings-header",
  "list-field-display-not-specified-caption" = "list-field-display-not-specified-caption",
  "add-object-to-list-tooltip" = "add-object-to-list-tooltip",
  "text-editor-align-label" = "text-editor-align-label",
  "image-editor-filters-label" = "image-editor-filters-label",
  "image-editor-filters-tooltip" = "image-editor-filters-tooltip",
...
export const uiLangRecords: Record<Lang, Record<UI_Words, string>> = {
  zh: {
    ...
    [UI_Words["list-field-settings-header"]]: "设置",
    [UI_Words["list-field-display-not-specified-caption"]]: "未指定",
    [UI_Words["add-object-to-list-tooltip"]]: "添加",
    [UI_Words["text-editor-align-label"]]: "对齐方式",
    [UI_Words["image-editor-filters-label"]]: "滤镜",
    [UI_Words["image-editor-filters-tooltip"]]: "配置图片滤镜",
  ...
  en: {
    ...
    [UI_Words["list-field-settings-header"]]: "Settings",
    [UI_Words["list-field-display-not-specified-caption"]]: "Not specified",
    [UI_Words["add-object-to-list-tooltip"]]: "Add",
    [UI_Words["text-editor-align-label"]]: "Align",
    [UI_Words["image-editor-filters-label"]]: "Filters",
    [UI_Words["image-editor-filters-tooltip"]]: "Configure image filters",
